...
const idMappings = {
  ...
  professors: new Map<number, string>(),
  academic_years: new Map<number, string>(),
  rooms: new Map<number, string>(),
  groups: new Map<number, string>(),
  courses: new Map<number, string>(),
 ...
 */
async function migrateDepartments(db: any) {
 ...
 */
async function migrateProfessors(db: any) {
 ...
 * Migre les cours
 */
async function migrateCourses(db: any) {
  console.log('\n=== Migration des cours ===')
 ...
 * Migre les salles
 */
async function migrateRooms(db: any) {
 ...
 * Migre les groupes
 */
async function migrateGroups(db: any) {
